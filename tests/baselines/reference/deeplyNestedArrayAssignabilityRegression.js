//// [tests/cases/compiler/deeplyNestedArrayAssignabilityRegression.ts] ////

//// [deeplyNestedArrayAssignabilityRegression.ts]
// Repro from #52912
...
// Reordered checks should also fail.
const reorderedTarget2: Target2 = source2;
const reorderedTarget1: Target1 = source1;


//// [deeplyNestedArrayAssignabilityRegression.js]
"use strict";
const target1 = source1;
const target2 = source2;
const target3 = source3;
const target4 = source4;
// Reordered checks should also fail.
const reorderedTarget2 = source2;
const reorderedTarget1 = source1;
