namespace ts {
     ...
     */
    const table: Record<ts.SyntaxKind, (node: Node, cbNode: (node: Node) => unknown, cbNodes?: (nodes: NodeArray<Node>) => unknown) => unknown> = Object.create(null);
    export function forEachChild<T>(node: Node, cbNode: (node: Node) => T | undefined, cbNodes?: (nodes: NodeArray<Node>) => T | undefined): T | undefined {
        ...
        if (fn) {
            return fn(node, cbNode, cbNodes) as T | undefined;
        }
    }

    table[SyntaxKind.QualifiedName] = (node, cbNode) => {
        return visitNode(cbNode, (<QualifiedName>node).left) || visitNode(cbNode, (<QualifiedName>node).right);
    };

    table[SyntaxKind.TypeParameter] = (node, cbNode) => {
        return visitNode(cbNode, (<TypeParameterDeclaration>node).name) ||
            visitNode(cbNode, (<TypeParameterDeclaration>node).constraint) ||
            visitNode(cbNode, (<TypeParameterDeclaration>node).default) ||
            visitNode(cbNode, (<TypeParameterDeclaration>node).expression);
    };
    table[SyntaxKind.ShorthandPropertyAssignment] = (node, cbNode, cbNodes) => {
    ...
    table[SyntaxKind.SpreadAssignment] = (node, cbNode) => {
        return visitNode(cbNode, (<SpreadAssignment>node).expression);
    };
    table[SyntaxKind.Parameter] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.PropertyDeclaration] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.PropertySignature] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.PropertyAssignment] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.VariableDeclaration] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.BindingElement] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.FunctionType] =
    table[SyntaxKind.ConstructorType] =
    table[SyntaxKind.CallSignature] =
    table[SyntaxKind.ConstructSignature] =
    table[SyntaxKind.IndexSignature] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.MethodDeclaration] =
    table[SyntaxKind.MethodSignature] =
    table[SyntaxKind.Constructor] =
    table[SyntaxKind.GetAccessor] =
    table[SyntaxKind.SetAccessor] =
    table[SyntaxKind.FunctionExpression] =
    table[SyntaxKind.FunctionDeclaration] =
    table[SyntaxKind.ArrowFunction] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.TypeReference] = (node, cbNode, cbNodes) => {
        return visitNode(cbNode, (<TypeReferenceNode>node).typeName) ||
            visitNodes(cbNode, cbNodes, (<TypeReferenceNode>node).typeArguments);
    };
    table[SyntaxKind.TypePredicate] = (node, cbNode) => {
    ...
    table[SyntaxKind.InferType] = (node, cbNode) => {
        return visitNode(cbNode, (<InferTypeNode>node).typeParameter);
    };
    table[SyntaxKind.ImportType] = (node, cbNode, cbNodes) => {
    ...
    table[SyntaxKind.ParenthesizedType] =
    table[SyntaxKind.TypeOperator] = (node, cbNode) => {
        return visitNode(cbNode, (<ParenthesizedTypeNode | TypeOperatorNode>node).type);
    };
    table[SyntaxKind.IndexedAccessType] = (node, cbNode) => {
        return visitNode(cbNode, (<IndexedAccessTypeNode>node).objectType) ||
            visitNode(cbNode, (<IndexedAccessTypeNode>node).indexType);
    };
    table[SyntaxKind.MappedType] = (node, cbNode) => {
    ...
    table[SyntaxKind.LiteralType] = (node, cbNode) => {
        return visitNode(cbNode, (<LiteralTypeNode>node).literal);
    };
    table[SyntaxKind.NamedTupleMember] = (node, cbNode) => {
    ...
    table[SyntaxKind.ObjectBindingPattern] =
    table[SyntaxKind.ArrayBindingPattern] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, (<BindingPattern>node).elements);
    };
    table[SyntaxKind.ArrayLiteralExpression] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, (<ArrayLiteralExpression>node).elements);
    };
    table[SyntaxKind.ObjectLiteralExpression] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, (<ObjectLiteralExpression>node).properties);
    };
    table[SyntaxKind.PropertyAccessExpression] = (node, cbNode) => {
    ...
    table[SyntaxKind.ElementAccessExpression] = (node, cbNode) => {
        return visitNode(cbNode, (<ElementAccessExpression>node).expression) ||
            visitNode(cbNode, (<ElementAccessExpression>node).questionDotToken) ||
            visitNode(cbNode, (<ElementAccessExpression>node).argumentExpression);
    };
    table[SyntaxKind.CallExpression] =
    table[SyntaxKind.NewExpression] = (node, cbNode, cbNodes) => {
    ...
    table[SyntaxKind.TaggedTemplateExpression] = (node, cbNode, cbNodes) => {
    ...
    table[SyntaxKind.ForInStatement] = (node, cbNode) => {
    ...
    table[SyntaxKind.ForOfStatement] = (node, cbNode) => {
    ...
    table[SyntaxKind.CatchClause] = (node, cbNode) => {
        return visitNode(cbNode, (<CatchClause>node).variableDeclaration) ||
            visitNode(cbNode, (<CatchClause>node).block);
    };
    table[SyntaxKind.Decorator] = (node, cbNode) => {
        return visitNode(cbNode, (<Decorator>node).expression);
    };
    table[SyntaxKind.ClassDeclaration] =
    table[SyntaxKind.ClassExpression] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.InterfaceDeclaration] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.TypeAliasDeclaration] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators) ||
            visitNodes(cbNode, cbNodes, node.modifiers) ||
    ...
    table[SyntaxKind.TemplateLiteralTypeSpan] = (node, cbNode) => {
        return visitNode(cbNode, (<TemplateLiteralTypeSpan>node).type) || visitNode(cbNode, (<TemplateLiteralTypeSpan>node).literal);
    };
    table[SyntaxKind.ComputedPropertyName] = (node, cbNode) => {
        return visitNode(cbNode, (<ComputedPropertyName>node).expression);
    };
    table[SyntaxKind.HeritageClause] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, (<HeritageClause>node).types);
    };
    table[SyntaxKind.ExpressionWithTypeArguments] = (node, cbNode, cbNodes) => {
    ...
    table[SyntaxKind.ExternalModuleReference] = (node, cbNode) => {
        return visitNode(cbNode, (<ExternalModuleReference>node).expression);
    };
    table[SyntaxKind.MissingDeclaration] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, node.decorators);
    };
    table[SyntaxKind.CommaListExpression] = (node, cbNode, cbNodes) => {
        return visitNodes(cbNode, cbNodes, (<CommaListExpression>node).elements);
    };
    table[SyntaxKind.JsxElement] = (node, cbNode, cbNodes) => {
        return visitNode(cbNode, (<JsxElement>node).openingElement) ||
            visitNodes(cbNode, cbNodes, (<JsxElement>node).children) ||
            visitNode(cbNode, (<JsxElement>node).closingElement);
    };
    table[SyntaxKind.JsxFragment] = (node, cbNode, cbNodes) => {
    ...
    table[SyntaxKind.JsxSelfClosingElement] =
    table[SyntaxKind.JsxOpeningElement] = (node, cbNode, cbNodes) => {
    ...
    table[SyntaxKind.JSDocAuthorTag] = (node, cbNode) => {
        return visitNode(cbNode, (node as JSDocTag).tagName);
    };
    table[SyntaxKind.JSDocImplementsTag] = (node, cbNode) => {
        return visitNode(cbNode, (node as JSDocTag).tagName) ||
            visitNode(cbNode, (<JSDocImplementsTag>node).class);
    };
    table[SyntaxKind.JSDocAugmentsTag] = (node, cbNode) => {
        return visitNode(cbNode, (node as JSDocTag).tagName) ||
            visitNode(cbNode, (<JSDocAugmentsTag>node).class);
    };
    table[SyntaxKind.JSDocTemplateTag] = (node, cbNode, cbNodes) => {
        return visitNode(cbNode, (node as JSDocTag).tagName) ||
            visitNode(cbNode, (<JSDocTemplateTag>node).constraint) ||
            visitNodes(cbNode, cbNodes, (<JSDocTemplateTag>node).typeParameters);
    };
    table[SyntaxKind.JSDocTypedefTag] = (node, cbNode) => {
        return visitNode(cbNode, (node as JSDocTag).tagName) ||
    ...
    table[SyntaxKind.JSDocCallbackTag] = (node, cbNode) => {
        return visitNode(cbNode, (node as JSDocTag).tagName) ||
            visitNode(cbNode, (node as JSDocCallbackTag).fullName) ||
            visitNode(cbNode, (node as JSDocCallbackTag).typeExpression);
    };
    table[SyntaxKind.JSDocReturnTag] =
    table[SyntaxKind.JSDocTypeTag] =
    table[SyntaxKind.JSDocThisTag] =
    table[SyntaxKind.JSDocEnumTag] = (node, cbNode) => {
        return visitNode(cbNode, (node as JSDocTag).tagName) ||
            visitNode(cbNode, (node as JSDocReturnTag | JSDocTypeTag | JSDocThisTag | JSDocEnumTag).typeExpression);
    };
    table[SyntaxKind.JSDocSignature] = (node, cbNode,) => {
    ...
    table[SyntaxKind.JSDocTypeLiteral] = (node, cbNode) => {
        return forEach((node as JSDocTypeLiteral).jsDocPropertyTags, cbNode);
    };
    table[SyntaxKind.JSDocTag] = 
    table[SyntaxKind.JSDocClassTag] =
    table[SyntaxKind.JSDocPublicTag] =
    table[SyntaxKind.JSDocPrivateTag] =
    table[SyntaxKind.JSDocProtectedTag] =
    table[SyntaxKind.JSDocReadonlyTag] = (node, cbNode) => {
        return visitNode(cbNode, (node as JSDocTag).tagName);
    };
    table[SyntaxKind.PartiallyEmittedExpression] = (node, cbNode) => {
