...
module ts {
    export var Diagnostics = {
        ...
        Contextual_assertions_may_only_be_used_where_a_contextual_type_exists: { code: 2502, category: DiagnosticCategory.Error, key: "Contextual assertions may only be used where a contextual type exists" },
